...
namespace PlayWithYourPeas.Logic
{
    ...
    internal class PointsController : GameComponent
    {
        ...
        /// Session score
        /// </summary>
        public Int32 PlayingScore { get; protected set; }
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            this.PlayingTime = PlayingTime.Add(TimeSpan.FromTicks((Int64)Math.Ceiling(gameTime.ElapsedGameTime.Ticks * this.RunningSpeed)));
        }
        ...
        public void Draw(ScreenManager sm)
        {
            ...
            foreach(var s in _active)
            {
                sm.SpriteBatch.DrawString(sm.SpriteFonts["Small"], String.Format("P: {0}", s.Points.ToString()), s.Pea.Position, 
                    s.Pea.IsNotHappy ? Microsoft.Xna.Framework.Color.Red : Microsoft.Xna.Framework.Color.Blue);
            }
            sm.SpriteBatch.End();
        }
#endif
