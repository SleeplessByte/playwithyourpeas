    ...
    internal class DataPea : GameComponent
    {
        ...
        internal void Jump(DataJumpSpot jumpspot)
        {
            ...
            if (jumpspot == null)
            {
                ...
                this.OnJumpStarted.Invoke(new JumpEventArgs(jumpspot, this));
                return;
            }
        ...
        internal void EndJump()
        {
            ...
            this.OnJumpCompleted.Invoke(new JumpEventArgs(_currentJumpSpot, this));
        ...
        internal void Die()
        {
            ...
            this.OnJumpFailed.Invoke(new JumpEventArgs(_currentJumpSpot, this));
