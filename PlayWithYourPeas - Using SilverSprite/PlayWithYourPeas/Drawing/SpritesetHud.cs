...
namespace PlayWithYourPeas.Drawing
{
    ...
    internal class SpritesetHud : Sprite
    {
        ...
        public override void Update(Microsoft.Xna.Framework.GameTime gameTime)
        {
            ...
            System.Diagnostics.Debug.WriteLine(_placingBlock.GridPosition);
...
#if SILVERLIGHT
            var targetColor = Color.Lerp(Color.White, ColorHelper.Green, Math.Min(1f, (_controller.PlayingScore - _displayScore) / 100f));
#else
