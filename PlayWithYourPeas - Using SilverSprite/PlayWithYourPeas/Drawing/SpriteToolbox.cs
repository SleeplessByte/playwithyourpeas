...
namespace PlayWithYourPeas.Drawing
{
    ...
    internal class SpriteToolbox : Sprite
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            _displaySelectionPosition = Vector2.Lerp(_displaySelectionPosition, Vector2.UnitY * (49 * _selectionIndex + 4), (Single)gameTime.ElapsedGameTime.TotalSeconds * 10);
        }
        ...
        public override void Draw(GameTime gameTime, Vector2 offset)
        {
            ...
            for (Int32 i = 0; i < _toolTypes.Length; i++)
                _tools[i].Draw(gameTime, offset - this.Position - Vector2.UnitY * (49 * i + 6) - Vector2.UnitX * 7);
