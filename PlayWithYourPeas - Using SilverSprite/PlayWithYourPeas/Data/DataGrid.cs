...
namespace PlayWithYourPeas.Data
{
    ...
    internal class DataGrid : GameComponent
    {
        ...
        /// 
        /// </summary>
        public static DataGrid Singleton { get; protected set; }

        /// <summary>
        /// Height of the grid
        /// </summary>
        public static Int32 Height = 10;

        /// <summary>
        /// Width of the grid
        /// </summary>
        public static Int32 Width = 17;

        /// <summary>
        /// Visual Width
        /// </summary>
        public static Int32 WidthInPixels = 70 * (Width);

        /// <summary>
        /// Visual Height
        /// </summary>
        public static Int32 HeightInPixels = 49 * (Height);
        ...
        public static DataGrid CreateDataGrid(Game game, Body fx, Int32 width = 17, Int32 height = 10)
        {
            Singleton = Singleton ?? new DataGrid(game, fx, width, height);

            if (DataGrid.Width != width || DataGrid.Height != height)
