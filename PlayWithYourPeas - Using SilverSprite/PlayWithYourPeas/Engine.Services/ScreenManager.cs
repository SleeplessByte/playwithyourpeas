...
namespace PlayWithYourPeas.Engine.Services
{
    ...
    public class ScreenManager : DrawableGameComponent
    {
        ...
        private static FontCollector _spriteFonts;
            ...
            : base(game)
        {
            ...
            _spriteFonts = new FontCollector(this.Game);
            this.Game.Components.Add(_spriteFonts);

            // Add Exiting Handler
#if SILVERLIGHT
            this.Game.Exiting += new EventHandler(GameExiting);
#else
        ...
        /// </summary>
        public FontCollector SpriteFonts
        {
            ...
            while (_screensToUpdate.Count > 0)
            {
                ...
                if (i_screen.IsEnabled)
                {
                        ...
                        i_screen.ScreenState == ScreenState.Active)
                    {
                        ...
                        if (!i_otherScreenHasFocus && i_screen.IsCapturingInput)
                        {
                        ...
                        if (!i_otherScreenHasFocus && i_screen.IsPopup)
                        {
                            i_screen.HandleInput(gameTime);
                        }
        ...
        internal void Resize(Int32 width, Int32 height)
        {
