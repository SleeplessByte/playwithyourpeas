...
namespace PlayWithYourPeas.Screens
{
    ...
    public class PauseOverlay : GameScreen
    {
        ...
        /// 
        /// </summary>
        public PauseOverlay(Camera2D camera, Int32 width, Int32 height)
            : base()
        {
            _camera = camera;
            _center = (Vector2.UnitX * width + Vector2.UnitY * height) / 2f;
