...
namespace PlayWithYourPeas.Engine.Drawing
{
    ...
    public class Camera3D : GameComponent
    {
        ...
        protected void UpdateBounds()
        {
            ...
            this.Bound = new BoundingBox(new Vector3(rect.Left, rect.Top, 0), new Vector3(rect.Right, rect.Bottom, 0));
        }
        ...
        protected void UpdateProjection(Vector3 newPosition, Vector3 newShakeOffset)
        {
            ...
            this.Projection = translation * obliqueProjection * shakeRotation * orthographic * taper;
        }
