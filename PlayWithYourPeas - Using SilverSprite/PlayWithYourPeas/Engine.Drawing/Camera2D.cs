...
namespace PlayWithYourPeas.Engine.Drawing
{
    ...
    {
        private const Single _minZoom = 0.02f;
        private const Single _maxZoom = 20f;
        ...
        private Single _currentRotation;

        private Single _currentZoom;
        private Vector2 _maxPosition;
        private Single _maxRotation;
        private Vector2 _minPosition;
        private Single _minRotation;
        private Boolean _positionTracking;
        private Matrix _projection;
        private Boolean _rotationTracking;
        private Vector2 _targetPosition;
        private Single _targetRotation;
        ...
        {
            base.Initialize();
            _graphics = this.Game.GraphicsDevice;
        ...
        /// <summary>
        /// The current zoom of the camera in radians.
        /// </summary>
        public float Zoom
        {
        ...
        private void SetView()
        {
            ...
            _batchView = Matrix.CreateTranslation(translateBody) *
                         matRotation *
                         matZoom *
                         Matrix.CreateTranslation(translateCenter * this.Zoom);
        }
